...
export_fields_t export_fields_openepc[] = {
    ...
    { IPFIX_ENO_FOKUS, IPFIX_FT_PT_QCI, 4},
    { IPFIX_ENO_FOKUS, IPFIX_FT_PT_MAX_DL, 4},
    { IPFIX_ENO_FOKUS, IPFIX_FT_PT_MAX_UL, 4},
    { IPFIX_ENO_FOKUS, IPFIX_FT_PT_GUARANTEED_DL, 4},
    { IPFIX_ENO_FOKUS, IPFIX_FT_PT_GUARANTEED_UL, 4},
    { IPFIX_ENO_FOKUS, IPFIX_FT_PT_APN_DL, 4},
    { IPFIX_ENO_FOKUS, IPFIX_FT_PT_APN_UL, 4},
    { 0, IPFIX_FT_SOURCEIPV4ADDRESS, 4},
    { 0, IPFIX_FT_SOURCETRANSPORTPORT, 2},
    { 0, IPFIX_FT_DESTINATIONIPV4ADDRESS, 4},
    { 0, IPFIX_FT_DESTINATIONTRANSPORTPORT, 2},
