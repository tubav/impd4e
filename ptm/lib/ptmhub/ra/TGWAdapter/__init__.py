...
class TGWAdapter(LegacyTGWClient, AbstractResourceAdapter):
	...
	def get_resource(self, identifier):
		...
		#raise Exception("huhuhu %s" % (identifier, ))
		r =  super(TGWAdapter, self).get_resource(identifier)
		#raise Exception(r.identifier)
		return r
	...
	def list_resources(self, parent, typename = None):
		...
		return super(TGWAdapter, self).list_resource(parent, typename)
